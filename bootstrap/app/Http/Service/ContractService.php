    ...
    public function analysis($id)
    {
        ...
        foreach((array)$Standard as $item)
        {
            ...
            if($description->InfoData){
                ...
                $sku_list[]=array('name'=>$sku_sys->ChineseName,'pic'=>isset($sku_sys->pic)?current($sku_sys->pic):'','sku'=>$sku_sys->ProductCode,'Count'=>$sku_sys->Count,'DetailCount'=>$sku_sys->DetailCount);
            }
